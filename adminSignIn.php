...
<head>
    ...
    <title> Admin Sign In | X-flax</title>
                    ...
                    <div class="card-body p-md-5">
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1 mt-5">
                                ...
                                <p class="text-center h1 fw-bold mb-2 mx-1 mx-md-4 mt-4" style="font-family: 'Times New Roman';">Admin Login</p>
                                <br />
                                <div class="text-center ">
                                    <div class="col-12 d-none" id="msgdiv" style="margin-left:13px;">
                                        <div class="alert alert-danger text-center" role="alert" id="msg" onclick="closeAlert4();">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-row align-items-center mb-2">
                                    ...
                                    <div class="form-outline flex-fill mb-0">
                                        ...
                                        <input type="text" placeholder="ex: sahan@gmail.com" class="form-control" id="e" />
                                ...
                                <div class="d-flex flex-row align-items-center mb-2 ">
                                    ...
                                    <div class="form-outline flex-fill mb-0">
                                        ...
                                        <div class="input-group">
                                            <input type="password" placeholder="ex: *******" class="form-control" id="pw" />
                                            <buton class="btn btn-outline-secondary" type="button" id="adminsignp2" onclick="showPassword5();">
                                ...
                                <div class="col-12  d-grid mt-4" style="margin-left:7px;">
                                    <button class="btn btn-dark" onclick="adminSignIn();">Sign In</button>
                                </div>
                            ...
                            <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                ...
                                <img src="resources/admin_Login.png" class="img-fluid" alt="Sample image">
