                        ...
                        <div class="row mt-2">
                            ...
                            ?>
                                <div class="col-12 d-grid">
                                    <button class="btn btn-success" id="ac" onclick="changeStatus(<?php echo $selected_data['id']; ?>);">Active</button>
                                </div>
                            <?php
                            } else {
                            ...
                            ?>
                                <div class="col-12 d-grid">
                                    <button class="btn btn-danger" id="de" onclick="changeStatus(<?php echo $selected_data['id']; ?>);">Deactive</button>
                                </div>
            ...
            <ul class="pagination pagination-lg justify-content-center">
                <li class="page-item">
                    <a class="page-link" <?php if ($pageno <= 1) {
                                            ...
                                            ?> onclick="manageSearch(<?php echo ($pageno - 1) ?>);" <?php
                                                                                                } ?> aria-label="Previous">
                ...
                ?>
                        <li class="page-item active">
                            <a class="page-link" onclick="manageSearch(<?php echo ($y); ?>);"><?php echo $y; ?></a>
                        </li>
                    <?php
                    } else {
                    ?>
