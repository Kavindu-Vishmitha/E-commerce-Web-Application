...
?>
    ...
    <head>
        ...
        <title>Users Report | X-flax</title>
    ...
    <body onload="loadUserReport();">
                        ...
                        <div class="offset-lg-3 col-12 col-lg-6 mb-4 mt-1">
                            <div class="row">
                                <div class="col-12 text-center">
                                    <P class="fs-1 mt-3 pt-2 fw-bold h1" style="font-family: 'Times New Roman';">Member Engagement</P>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="col-lg-2 offset-lg-5 d-grid mb-lg-5 col-4 offset-4 mb-5">
            <button class="btn btn-primary" onclick="printProRep();">Download</button>
        </div>
