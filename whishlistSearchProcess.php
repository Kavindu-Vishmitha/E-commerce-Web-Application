                    ...
                    <div class="card-body ms-0 m-0 text-center">
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-12 d-grid">
                                <button class="btn btn-dark" onclick="addToWhishlistSearch(<?php echo $selected_data['id']; ?>);" style="font-weight: bold;">Add to Watchlist</button>
                            </div>
            ...
            <ul class="pagination pagination-lg justify-content-center">
                <li class="page-item">
                    <a class="page-link" <?php if ($pageno <= 1) {
                                            ...
                                            ?> onclick="whishlistSearch(<?php echo ($pageno - 1) ?>);" <?php
                                                                                                    } ?> aria-label="Previous">
                ...
                ?>
                        <li class="page-item active">
                            <a class="page-link" onclick="whishlistSearch(<?php echo ($y); ?>);"><?php echo $y; ?></a>
                        </li>
                    <?php
                    } else {
                    ?>
